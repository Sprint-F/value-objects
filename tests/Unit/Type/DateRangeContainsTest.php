 ...
 * @coversNothing
 */
class DateRangeContainsTest extends Unit
{
    ...
    private array $contains = [
        ...
        '(,2000-01-01)' => [
            // $that
            '(,2000-01-01)' => true, '(,2001-01-01)' => false, '(,2002-01-01)' => false, '(,2003-01-01)' => false, '(,)' => false,
        ...
        '(,2001-01-01)' => [
            // $that
            '(,2000-01-01)' => true, '(,2001-01-01)' => true, '(,2002-01-01)' => false, '(,2003-01-01)' => false, '(,)' => false,
            '[2000-01-01,2001-01-01)' => true, '[2000-01-01,2002-01-01)' => false, '[2000-01-01,2003-01-01)' => false, '[2000-01-01,)' => false,
            '[2001-01-01,2002-01-01)' => false, '[2001-01-01,2003-01-01)' => false, '[2001-01-01,)' => false,
            '[2002-01-01,2003-01-01)' => false, '[2002-01-01,)' => false,
            '[2003-01-01,)' => false,
        ],
        '(,2002-01-01)' => [
            // $that
            '(,2000-01-01)' => true, '(,2001-01-01)' => true, '(,2002-01-01)' => true, '(,2003-01-01)' => false, '(,)' => false,
            '[2000-01-01,2001-01-01)' => true, '[2000-01-01,2002-01-01)' => true, '[2000-01-01,2003-01-01)' => false, '[2000-01-01,)' => false,
            '[2001-01-01,2002-01-01)' => true, '[2001-01-01,2003-01-01)' => false, '[2001-01-01,)' => false,
            '[2002-01-01,2003-01-01)' => false, '[2002-01-01,)' => false,
            '[2003-01-01,)' => false,
        ],
        '(,2003-01-01)' => [
            // $that
            '(,2000-01-01)' => true, '(,2001-01-01)' => true, '(,2002-01-01)' => true, '(,2003-01-01)' => true, '(,)' => false,
            '[2000-01-01,2001-01-01)' => true, '[2000-01-01,2002-01-01)' => true, '[2000-01-01,2003-01-01)' => true, '[2000-01-01,)' => false,
            '[2001-01-01,2002-01-01)' => true, '[2001-01-01,2003-01-01)' => true, '[2001-01-01,)' => false,
            '[2002-01-01,2003-01-01)' => true, '[2002-01-01,)' => false,
            '[2003-01-01,)' => false,
        ],
        '(,)' => [
            // $that
        ...
        '[2000-01-01,2001-01-01)' => [
            // $that
            '(,2000-01-01)' => false, '(,2001-01-01)' => false, '(,2002-01-01)' => false, '(,2003-01-01)' => false, '(,)' => false,
            '[2000-01-01,2001-01-01)' => true, '[2000-01-01,2002-01-01)' => false, '[2000-01-01,2003-01-01)' => false, '[2000-01-01,)' => false,
            '[2001-01-01,2002-01-01)' => false, '[2001-01-01,2003-01-01)' => false, '[2001-01-01,)' => false,
            '[2002-01-01,2003-01-01)' => false, '[2002-01-01,)' => false,
            '[2003-01-01,)' => false,
    ...
    public function testContains()
    {
        foreach ($this->this as $thisRange) {
            foreach ($this->that as $thatRange) {
                $this->assertSame(
                    $this->contains[(string) $thisRange][(string) $thatRange] ?? null,
                    $thisRange->contains($thatRange),
